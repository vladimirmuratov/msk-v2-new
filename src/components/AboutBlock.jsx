    ...
    return (
        <Box id="about" sx={{
            ...
            <Typography component="p" sx={{ fontSize: 20 }}>
                Мы осуществляем свою деятельность в тесной связи с ФГБУ "Объединенная больница", подведомственным УД
                Президента РФ, обеспечивая доступ к высококлассной медицине круглосуточно.
            </Typography>
        </Box>
    );
};
